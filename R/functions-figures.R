...
pFixFig_Neutral_Ben  <-  function() {
    ...
    ## import data.frames
    # Neutral sims
    neutral_N100k  <-  read.csv(file = "./output/data/simResults/PrFixFig_Haploid_h0.25_s0.01_N100k.csv")

    # beneficial sims
    ben_N100k <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.02_N100k.csv")
...
## Panel A: Neutral Inversions
    ...
    par(omi=c(0.25, 0.5, 0.25, 0.5), mar = c(5,4,1,1), bty='o', xaxt='s', yaxt='s')    
     plot(NA, axes=FALSE, type='n', main='', xlim = c(0,1), ylim = c((2/10^6), 2/(10^3)), log='y', ylab='', xlab='', cex.lab=1.2)
        usr  <-  par('usr')
        ...
        points(PrFix[U == 0.02] ~ x[U == 0.02], pch=21, bg=transparentColor(COLS[1], opacity=0.4), data=neutral_N100k)
        points(PrFix[U == 0.05] ~ x[U == 0.05], pch=22, bg=transparentColor(COLS[1], opacity=0.4), data=neutral_N100k)
        points(PrFix[U == 0.1] ~ x[U == 0.1], pch=24, bg=transparentColor(COLS[1], opacity=0.4), data=neutral_N100k)
        # Axes
        axis(1, las=1, labels=NA)
        axis(2, las=1, at=c(2/10^6, 2/10^5, 2/10^4, 2/10^3, 2/10^2), 
                labels=c(0, expression(2/10^5), expression(2/10^4), expression(2/10^3), expression(2/10^2)))
        # Plot labels etc.
...
## Panel B: Beneficial Inverions
    ...
    plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1), ylim = c(0,2.2), ylab='', xlab='', cex.lab=1.2)
        ...
        points(PrFix[U == 0.02]/sI[U == 0.02] ~ x[U == 0.02], pch=21, bg=transparentColor(COLS[1], opacity=0.4), data=ben_N100k)
        points(PrFix[U == 0.05]/sI[U == 0.05] ~ x[U == 0.05], pch=22, bg=transparentColor(COLS[1], opacity=0.4), data=ben_N100k)
        points(PrFix[U == 0.1]/sI[U == 0.1] ~ x[U == 0.1], pch=24, bg=transparentColor(COLS[1], opacity=0.4), data=ben_N100k)
        # axes
        axis(1, las=1)
...
pFixFig_SA_r  <-  function() {
    ...
    ## import data.frames
    SA_add_r1  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.00184493772801948_SA_sIApprox_N100k_r0.002_sf0.05_sm0.05_hf0.5_hm0.5.csv")
    SA_add_r2  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.00570874426150777_SA_sIApprox_N100k_r0.008_sf0.05_sm0.05_hf0.5_hm0.5.csv")
    SA_add_r3  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.0103478345233318_SA_sIApprox_N100k_r0.032_sf0.05_sm0.05_hf0.5_hm0.5.csv")
    SA_add_r4  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.0121595103017582_SA_sIApprox_N100k_r0.124_sf0.05_sm0.05_hf0.5_hm0.5.csv")
    SA_add_r5  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.0126555145027055_SA_sIApprox_N100k_r0.498_sf0.05_sm0.05_hf0.5_hm0.5.csv")

    SA_DomRev_r1  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.00176844184129087_SA_sIApprox_N100k_r0.002_sf0.05_sm0.05_hf0.25_hm0.25.csv")
    SA_DomRev_r2  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.00537637865255959_SA_sIApprox_N100k_r0.008_sf0.05_sm0.05_hf0.25_hm0.25.csv")
    SA_DomRev_r3  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.0100311949252778_SA_sIApprox_N100k_r0.032_sf0.05_sm0.05_hf0.25_hm0.25.csv")
    SA_DomRev_r4  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.0120589122712059_SA_sIApprox_N100k_r0.124_sf0.05_sm0.05_hf0.25_hm0.25.csv")
    SA_DomRev_r5  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.0126558703344925_SA_sIApprox_N100k_r0.498_sf0.05_sm0.05_hf0.25_hm0.25.csv")
...
## Panel A -- U/(hs) = 8 -- Additive SA Fitness Effects
    ...
    plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1), ylim = c(0,0.03), ylab='', xlab='', cex.lab=1.2)
        usr  <-  par('usr')
        rect(usr[1], usr[3], usr[2], usr[4], col='white', border=NA)
        plotGrid(lineCol='grey80')
        box()
...
pFixFig_SA_biasedSel_r  <-  function() {
    ...
    ## import data.frames
    SA_add_biased_r1  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.0018602942914487_SA_sIApprox_N100k_r0.002_sf0.0526315789473684_sm0.05_hf0.5_hm0.5.csv")
    SA_add_biased_r2  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.00591848147242744_SA_sIApprox_N100k_r0.008_sf0.0526315789473684_sm0.05_hf0.5_hm0.5.csv")
    SA_add_biased_r3  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.0117843365165588_SA_sIApprox_N100k_r0.032_sf0.0526315789473684_sm0.05_hf0.5_hm0.5.csv")
    SA_add_biased_r4  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.0173783080495398_SA_sIApprox_N100k_r0.124_sf0.0526315789473684_sm0.05_hf0.5_hm0.5.csv")
    SA_add_biased_r5  <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.0262865899936689_SA_sIApprox_N100k_r0.498_sf0.0526315789473684_sm0.05_hf0.5_hm0.5.csv")
...
pFixFig_combined  <-  function() {
    ...
    ## import data.frames
    # Neutral sims
#    neutral_N10k   <-  read.csv(file = "./output/data/simResults/PrFixFig_Haploid_h0.25_s0.01_N10k.csv")
    neutral_N100k  <-  read.csv(file = "./output/data/simResults/PrFixFig_Haploid_h0.25_s0.01_N100k.csv")
    
    neutral_N100k$PrFix[neutral_N100k$PrFix == 0]  <-  1e-7
    
    # beneficial sims
    ben_N100k <-  read.csv(file = "./output/data/simResults/PrFixFig_Beneficial_Haploid_h0.25_s0.01_sI0.02_N100k.csv")

    ## SA selection
    SA_add_r1  <-  read.csv(file = "./output/data/simResults/SA_PrFixFig_rSA0.002_sf0.05_sm0.05_hSA0.5_h0.25_s0.01_NumEqFreq_N100k.csv")
    SA_add_r2  <-  read.csv(file = "./output/data/simResults/SA_PrFixFig_rSA0.008_sf0.05_sm0.05_hSA0.5_h0.25_s0.01_NumEqFreq_N100k.csv")
    SA_add_r3  <-  read.csv(file = "./output/data/simResults/SA_PrFixFig_rSA0.032_sf0.05_sm0.05_hSA0.5_h0.25_s0.01_NumEqFreq_N100k.csv")
    SA_add_r4  <-  read.csv(file = "./output/data/simResults/SA_PrFixFig_rSA0.124_sf0.05_sm0.05_hSA0.5_h0.25_s0.01_NumEqFreq_N100k.csv")
    SA_add_r5  <-  read.csv(file = "./output/data/simResults/SA_PrFixFig_rSA0.498_sf0.05_sm0.05_hSA0.5_h0.25_s0.01_NumEqFreq_N100k.csv")
...
## Panel A: Neutral Inversions
    ...
    par(omi=c(0.25, 0.5, 0.5, 0.5), mar = c(5,4,1,1), bty='o', xaxt='s', yaxt='s')    
     plot(NA, axes=FALSE, type='n', main='', xlim = c(0,1), ylim = c((1/10^7), 2/(10^4)), log='y', ylab='', xlab='', cex.lab=1.2)
        usr  <-  par('usr')
        rect(usr[1], usr[3], usr[2], usr[4], col='white', border=NA)
        plotGrid(lineCol='grey80', log='y')
        box()
        # pInv
        abline(h=pFixNeutral, lwd=2, lty=2, col=transparentColor(COLS[1], opacity=1.0))
        points(PrFix[U == 0.02] ~ x[U == 0.02], pch=21, bg=transparentColor(COLS[4], opacity=0.8), data=neutral_N100k)
        points(PrFix[U == 0.05] ~ x[U == 0.05], pch=22, bg=transparentColor(COLS[4], opacity=0.8), data=neutral_N100k)
        points(PrFix[U == 0.1]  ~ x[U == 0.1],  pch=24, bg=transparentColor(COLS[4], opacity=0.8), data=neutral_N100k)
        # Axes
        axis(1, las=1, labels=NA)
...
## Panel B: Beneficial Inversions
    ...
    plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1), ylim = c(0,3), ylab='', xlab='', cex.lab=1.2)
        ...
        # pInv
        abline(h=2, lwd=2, lty=2, col=transparentColor(COLS[1], opacity=1.0))
        points(PrFix[U == 0.02]/sI[U == 0.02] ~ x[U == 0.02], pch=21, bg=transparentColor(COLS[4], opacity=0.8), data=ben_N100k)
        points(PrFix[U == 0.05]/sI[U == 0.05] ~ x[U == 0.05], pch=22, bg=transparentColor(COLS[4], opacity=0.8), data=ben_N100k)
        points(PrFix[U == 0.1]/sI[U == 0.1]   ~ x[U == 0.1],  pch=24, bg=transparentColor(COLS[4], opacity=0.8), data=ben_N100k)
        # axes
        axis(1, las=1)
        axis(2, las=1, at=c(0, 1, 2, 3), 
                labels=c(0, 
...
#    neutral_N10k   <-  read.csv(file = "./output/data/simResults/PrFixFig_Haploid_h0.25_s0.01_N10k.csv")
    neutral_N100k  <-  read.csv(file = "./output/data/simResults/PrFixFig_Haploid_h0.25_s0.01_N100k.csv")    
    neutral_N100k$PrFix[neutral_N100k$PrFix == 0]  <-  1e-7 # Convenience for plotting 0 probabilities on log scale
...
## Panel A: Neutral Inversions
    ...
    par(omi=c(0.25, 0.25, 0.5, 0.25), mar = c(5,4,1,1), bty='o', xaxt='s', yaxt='s')    
     plot(NA, axes=FALSE, type='n', main='', xlim = c(0,1), ylim = c((1/10^7), 2/(10^4)), log='y', ylab='', xlab='', cex.lab=1.2)
        ...
        # Axes
        axis(1, las=1, labels=NA)
        axis(2, las=1, at=c(1/10^7, 2/10^7, 2/10^6, 2/10^5, 2/10^4), 
        ...
        proportionalLabel(0.04, 1.075, 'A', cex=1.2, adj=c(0.5, 0.5), xpd=NA, log='y')
        proportionalLabel(-0.0175, 0.13, '_', cex=1.2, adj=c(0.5, 0.5), xpd=NA,log='y', srt=30)
        proportionalLabel(-0.0175, 0.11, '_', cex=1.2, adj=c(0.5, 0.5), xpd=NA,log='y', srt=30)
        proportionalLabel(-0.3,  0.5,   expression(paste("Fixation Probability")), cex=1.2, adj=c(0.5, 0.5), xpd=NA, srt=90, log='y')        
...
## Panel C -- Additive SA Fitness Effects -- r = 1/2
    plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1), ylim = c(0,0.005), ylab='', xlab='', cex.lab=1.2)
        usr  <-  par('usr')
        rect(usr[1], usr[3], usr[2], usr[4], col='white', border=NA)
        plotGrid(lineCol='grey80')
        box()
...
## Panel D -- Additive SA Fitness Effects -- r = 0.002
    plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1), ylim = c(0,2/10^4), ylab='', xlab='', cex.lab=1.2)
        usr  <-  par('usr')
        rect(usr[1], usr[3], usr[2], usr[4], col='white', border=NA)
        plotGrid(lineCol='grey80')
        box()
...
### ROW 1: SLR_pos = 1/2
    ...
    neutral_N100k$pSpanFix  <-  neutral_N100k$PrFix * PrCatchSLR(SLR_pos=SLR_pos, x = neutral_N100k$x)
    neutral_N100k$pSpanFix[neutral_N100k$pSpanFix < 1/10^7]  <-  1/10^7 # Convenience for plotting 0 probabilities on log scale
...
## Panel A: Neutral Inversions
    ...
    par(omi=c(0.25, 0.5, 0.5, 0.25), mar = c(4.5,4,1,1), bty='o', xaxt='s', yaxt='s')    
     plot(NA, axes=FALSE, type='n', main='', xlim = c(0,1), ylim = c((1/10^7), 2/(10^4)), log='y', ylab='', xlab='', cex.lab=1.2)
        ...
        points(pSpanFix[U == 0.02] ~ x[U == 0.02], pch=21, bg=transparentColor(COLS[4], opacity=0.8), data=neutral_N100k)
        points(pSpanFix[U == 0.05] ~ x[U == 0.05], pch=22, bg=transparentColor(COLS[4], opacity=0.8), data=neutral_N100k)
        points(pSpanFix[U == 0.1]  ~ x[U == 0.1],  pch=24, bg=transparentColor(COLS[4], opacity=0.8), data=neutral_N100k)
        # Axes
        axis(1, las=1, labels=NA)
        axis(2, las=1, at=c(1/10^7, 2/10^7, 2/10^6, 2/10^5, 2/10^4), 
                labels=c(0, expression(2/10^7), expression(2/10^6), expression(2/10^5), expression(2/10^4)))
        ...
        proportionalLabel(0.04, 1.075, 'A', cex=1.2, adj=c(0.5, 0.5), xpd=NA, log='y')
        proportionalLabel(-0.01, 0.13, '_', cex=1.2, adj=c(0.5, 0.5), xpd=NA, log='y', srt=30)
        proportionalLabel(-0.01, 0.11, '_', cex=1.2, adj=c(0.5, 0.5), xpd=NA, log='y', srt=30)
...
## Panel B: Beneficial Inversions
    plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1), ylim = c(0,2.2), ylab='', xlab='', cex.lab=1.2)
        ...
        points(PrFix[U == 0.02]*PrCatchSLR(SLR_pos=SLR_pos, x = x[U == 0.02])/sI[U == 0.02] ~ x[U == 0.02], pch=21, bg=transparentColor(COLS[4], opacity=0.8), data=ben_N100k)
        points(PrFix[U == 0.05]*PrCatchSLR(SLR_pos=SLR_pos, x = x[U == 0.05])/sI[U == 0.05] ~ x[U == 0.05], pch=22, bg=transparentColor(COLS[4], opacity=0.8), data=ben_N100k)
        points(PrFix[U == 0.1]*PrCatchSLR(SLR_pos=SLR_pos, x = x[U == 0.1])/sI[U == 0.1]   ~ x[U == 0.1],  pch=24, bg=transparentColor(COLS[4], opacity=0.8), data=ben_N100k)
        # axes
        axis(1, las=1, labels=NA)
        axis(2, las=1, at=c(0, 1, 2, 3), 
                labels=c(0, 
...
plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1), ylim = c(0,0.00525), ylab='', xlab='', cex.lab=1.2)
        usr  <-  par('usr')
        rect(usr[1], usr[3], usr[2], usr[4], col='white', border=NA)
        plotGrid(lineCol='grey80')
        box()
...
plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1), ylim = c(0,0.0055), ylab='', xlab='', cex.lab=1.2)
        usr  <-  par('usr')
        rect(usr[1], usr[3], usr[2], usr[4], col='white', border=NA)
        plotGrid(lineCol='grey80')
        box()
...
### ROW 1: SLR_pos = 1/2
    ...
    neutralRBP      <-  neutral_N100k$PrFix[neutral_N100k$U == Ud]*PrCatchSLR(SLR_pos=SLR_pos, x = neutral_N100k$x[neutral_N100k$U == Ud])*distNewInvRBP(x=neutral_N100k$x[neutral_N100k$U == Ud])
    neutralRBP      <-  neutralRBP / sum(neutralRBP)
    beneficialRBP   <-  (ben_N100k$PrFix[ben_N100k$U == Ud]*PrCatchSLR(SLR_pos=SLR_pos, x = ben_N100k$x[ben_N100k$U == Ud])/ben_N100k$sI[ben_N100k$U == Ud])*distNewInvRBP(x=ben_N100k$x[ben_N100k$U == Ud])
    ...
    neutralEXP      <-  neutral_N100k$PrFix[neutral_N100k$U == Ud]*PrCatchSLR(SLR_pos=SLR_pos, x = neutral_N100k$x[neutral_N100k$U == Ud])*distNewInvEXP(x=neutral_N100k$x[neutral_N100k$U == Ud], lambda=10)
    neutralEXP      <-  neutralEXP / sum(neutralEXP)
    beneficialEXP   <-  (ben_N100k$PrFix[ben_N100k$U == Ud]*PrCatchSLR(SLR_pos=SLR_pos, x = ben_N100k$x[ben_N100k$U == Ud])/ben_N100k$sI[ben_N100k$U == Ud])*distNewInvEXP(x=ben_N100k$x[ben_N100k$U == Ud], lambda=10)
    ...
    x  <-  neutral_N100k$x[neutral_N100k$U == Ud]
...
## Panel D: Exponential Model
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1), ylim = c(0,1.05*(max(neutralEXP,beneficialEXP,SAlinked_EXP,SAunlinked_EXP))), ylab='', xlab='', cex.lab=1.2)
        ...
        proportionalLabel( px=c(0.415,0.465,0.515,0.565), py=c(0.615,0.615,0.615,0.615), pch=c(21,22,24,25), bg= transparentColor(COLS[1], opacity=1), cex=1, adj=c(0.5, 0.5), xpd=NA, text=FALSE)
...
recombEffectSATwoLocus  <-  function() {
    ...
    ## import data.frames
    # Equal Selection
    EqualSelAdd     <-  read.csv(file = "./output/data/simResults/SA-sI-EqualSelTable_hf0.5_hm0.5.csv")
    EqualSelDomRev  <-  read.csv(file = "./output/data/simResults/SA-sI-EqualSelTable_hf0.25_hm0.25.csv")

    # Biased Selection
    MaleBiasedSel    <-  read.csv(file = "./output/data/simResults/SA-sI-MaleBiasedSel_sf0.05_hf0.5_hm0.5.csv")

    # set plot layout
    layout.mat <- matrix(c(1:2), nrow=1, ncol=2, byrow=TRUE)
    layout     <- layout(layout.mat,respect=TRUE)

## Panel A: Equal Selection (sf = sm)
    par(omi=c(0.5, 0.5, 0.75, 0.5), mar = c(2,3,3,1), bty='o', xaxt='s', yaxt='s')    
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1/2), ylim = c(0,(1.05*0.013)), ylab='', xlab='', cex.lab=1.2)
        ...
        box()
        # sI
        sLevs  <-  unique(EqualSelAdd$sf)
        lines(sI[EqualSelAdd$sf == sLevs[1]] ~ r[EqualSelAdd$sf == sLevs[1]], lwd=2, lty=1, col=transparentColor('#252525', opacity=0.2), data=EqualSelAdd)
        lines(sI[EqualSelAdd$sf == sLevs[2]] ~ r[EqualSelAdd$sf == sLevs[2]], lwd=2, lty=1, col=transparentColor('#252525', opacity=0.4), data=EqualSelAdd)
        lines(sI[EqualSelAdd$sf == sLevs[3]] ~ r[EqualSelAdd$sf == sLevs[3]], lwd=2, lty=1, col=transparentColor('#252525', opacity=0.6), data=EqualSelAdd)
        lines(sI[EqualSelAdd$sf == sLevs[4]] ~ r[EqualSelAdd$sf == sLevs[4]], lwd=2, lty=1, col=transparentColor('#252525', opacity=0.8), data=EqualSelAdd)
        lines(sI[EqualSelAdd$sf == sLevs[5]] ~ r[EqualSelAdd$sf == sLevs[5]], lwd=2, lty=1, col=transparentColor('#252525', opacity=1.0), data=EqualSelAdd)
        # axes
        axis(1, labels=TRUE)
...
## Panel B: Biased selection sm = sf / (1 - sf)
     plot(NA, axes=FALSE, type='n', main='',xlim = c(0,1/2), ylim = c(0,(1.05*0.013)), ylab='', xlab='', cex.lab=1.2)
        usr  <-  par('usr')
        rect(usr[1], usr[3], usr[2], usr[4], col='white', border=NA)
        plotGrid(lineCol='grey80')
        box()
        # sI
        sLevs  <-  unique(MaleBiasedSel$sf)
        lines(sI[MaleBiasedSel$sf == sLevs[1]] ~ r[MaleBiasedSel$sf == sLevs[1]], lwd=2, lty=1, col=transparentColor('#252525', opacity=0.2), data=MaleBiasedSel)
        lines(sI[MaleBiasedSel$sf == sLevs[2]] ~ r[MaleBiasedSel$sf == sLevs[2]], lwd=2, lty=1, col=transparentColor('#252525', opacity=0.4), data=MaleBiasedSel)
        lines(sI[MaleBiasedSel$sf == sLevs[3]] ~ r[MaleBiasedSel$sf == sLevs[3]], lwd=2, lty=1, col=transparentColor('#252525', opacity=0.6), data=MaleBiasedSel)
        lines(sI[MaleBiasedSel$sf == sLevs[4]] ~ r[MaleBiasedSel$sf == sLevs[4]], lwd=2, lty=1, col=transparentColor('#252525', opacity=0.8), data=MaleBiasedSel)
        lines(sI[MaleBiasedSel$sf == sLevs[5]] ~ r[MaleBiasedSel$sf == sLevs[5]], lwd=2, lty=1, col=transparentColor('#252525', opacity=1.0), data=MaleBiasedSel)
        # axes
        axis(1, labels=TRUE)
        ...
        proportionalLabel(0.5, 1.075, expression(paste(italic(s[m]), " = ", italic(s[f]), "/(1 - ", italic(s[f]), ")")), cex=1.2, adj=c(0.5, 0.5), xpd=NA, srt=0)        
        proportionalLabel( 0.5,  -0.25,  expression(paste(italic(r[SA]))), cex=1.2, adj=c(0.5, 0.5), xpd=NA)        
        # Legend
        legend(
               x       =  usr[2],
               y       =  usr[4],
               legend  =  c(
                            expression(paste(italic(s[f]), " = ",1/20)),
                            expression(paste(italic(s[f]), " = ",1/40)),
                            expression(paste(italic(s[f]), " = ",1/60)),
                            expression(paste(italic(s[f]), " = ",1/80)),
                            expression(paste(italic(s[f]), " = ",1/100))),
               lty     =  1,
               lwd     =  2,
               col     =  c(transparentColor('#252525', opacity=1.0),
