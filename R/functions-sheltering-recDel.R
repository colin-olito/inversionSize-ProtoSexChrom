...
#'  Author: Colin Olito
#'
#'  NOTES:  Functions copied from Supplement to 
#' 
#' 			Olito, Ponnikas, Hansson, Abbott (2022). Consequences
...
# Neutral inversion expanding SLR w/ partially recessive deleterious mutations
...
#t=t+1
	...
	filename  <-  paste("./output/data/simResults/shelter_PrFixFig_h", h, "_s", s, Nfname, ".csv", sep="")
	d  <-  data.frame(
