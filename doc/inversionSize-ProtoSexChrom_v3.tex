...
\noindent {\itshape Online Supporting Information}: Appendix A -- Neutural inversions; Appendix B -- Beneficial Inversions; Appendix C -- Inversions capturing sexually antagonistic loci; Appendix D -- Supplementary Figures; Online Supplementary File -- Mathematica code (.nb file \& PDF) to reproduce analytic results.
...
%so because they have a smaller effective population size than X-linked inversions ($N_Y < N_X$), and have no opportunity to experience sex-differences in selection 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=0.95\linewidth]{./CartoonDiagramFig_v2_JKA.pdf}
...
%%%%%%%%%%%%%%%
 \begin{figure}[H]
 \centering
 \includegraphics[width=0.85\linewidth]{./PrFix_PrCatchSA_combined_delMut}
...
%%%%%%%%%%%%%%%%%%%%%%%%
%\subsection*{Supporting Informations}
%Requests for Supporting Information and correspondence can be directed to C.O. (\url{colin.olito@gmail.com}).
